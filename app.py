...
def Upload():
    if request.method == 'POST':
        ...
        model = keras.models.load_model(r'E:\Major Project\Project Implementation\model\model_64.h5')
        categories = ["NonDemented", "MildDemented", "ModerateDemented", "VeryMildDemented"]

        nimage = cv2.imread(r"E:\Major Project\Project Implementation\static\uploader\1.png", cv2.IMREAD_GRAYSCALE)
